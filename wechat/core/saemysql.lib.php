 ...
 * <code>
 * <?php
 * $mysql = new SaeMysql('localhost','root','pass','dbname');
 *
...
class SaeMysql
{
     ...
     */
    function __construct( $host = MYSQL_HOST, $username = MYSQL_USERNAME, $pass = MYSQL_PASS, $db = MYSQL_DBNAME, $port = 3306, $do_replication = true )
    {
        $this->port = $port;
        $this->host = $host;
